# Lean 4 数学形式化・学習実験リポジトリ

AI-assisted Lean 4 learning project — exploring formal mathematics with Mathlib.

このリポジトリは、Lean 4 と Mathlib を用いて数学の形式化を学ぶための実験ログです。
基礎的な命題から始め、代数・解析・圏論・数論など幅広い分野を探索しています。

## 注意

このリポジトリは査読済みの数学論文ではありません。

- 多くのファイルは学習・実験・試行錯誤の記録です。
- 一部のLeanファイルには `sorry`, `admit`, `axiom` が残っている可能性があります。
